                                ...
                                <div class="mb-3 rounded-end">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="listaCarrera" class="form-select listaDespliege "
                                                onchange="retrasoSelect('claveCarrera', 'btnAgregarOferta', 'oferta','mb-3' )">
                            ...
                            <div class=" col-md-5-5 bg-light border rounded p-3  margin-izquierda ">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="listaPeriodo" class="form-select listaDespliege "
                                                onchange="retrasoSelect('IdPeriod', 'btnAgregarOferta', 'oferta','mb-3' )">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select listaDespliege" id="turno"
                                                onchange="retrasoSelect('turno', 'btnAgregarOferta', 'oferta','col-md-4' )">
                            ...
                            <div class="col-md-5-5 bg-light border rounded p-3 margin-derecha margin-izquierda">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="listaMateria" class="form-select listaDespliege"
                                                onchange="retrasoSelect('claveMateria', 'btnAgregarOferta', 'oferta','mb-3' )"
                                                disabled>
                            ...
                            <div class=" col-md-5-5 bg-light border rounded p-3 margin-izquierda">
                                <div class="mb-3  ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="listaDocente" class="form-select listaDespliege "
                                                onchange="retrasoSelect('claveDocente', 'btnAgregarOferta', 'oferta','mb-3' )">
